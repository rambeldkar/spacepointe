...
class Mainbannerleft extends Component {
    componentDidMount() {
        AOS.init();
     }
    ...
    render() {
        return (
            ...
            <div  className="carousel slide bannerleft-section">  
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={this.props.mainBannerImg} className="fluid-image" data-aos="fade-in" alt="" />                
                        <div className="container d-flex justify-content-start flex-row h-100">
